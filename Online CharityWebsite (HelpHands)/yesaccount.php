...
<div class="row text-center">
    <br>
    <br>
<p style="border-color: #c0c0c0; font-size: 40px">Please enter your information</p><br>
<div class="con-form clearfix">
    <form method="POST">
        <div >
        <input  type="text" style="width: 553px; height: 45px; border-color: #c0c0c0; font-weight: bold; padding-left: 5px; border-radius: 10px" name="name"aria-required="true" aria-invalid="false" placeholder="First Name" id="username" />
        </div>
        <div >
        <input  type="text" style="width: 553px; height: 45px; border-color: #c0c0c0; font-weight: bold; padding-left: 5px; border-radius: 10px" name="last"aria-required="true" aria-invalid="false" placeholder="Last Name" id="username" />
        </div>
        <div >
        <input  type="text" style="width: 553px; height: 45px; border-color: #c0c0c0; font-weight: bold; padding-left: 5px; border-radius: 10px" name="email" aria-required="true" aria-invalid="false" size="46" placeholder="Email" id="email"  onblur="checkemail();"/>
        </div>
        <div >
        <input type="text"style="width: 553px; height: 45px; border-color: #c0c0c0; font-weight: bold; padding-left: 5px; border-radius: 10px" name="phone" aria-required="true" aria-invalid="false" size="46"placeholder="Phone Number" id="phone" onblur="checkphone();"/>
        </div>
        <div >
        <input  type="password" style="width: 553px; height: 45px; border-color: #c0c0c0; font-weight: bold; padding-left: 5px; border-radius: 10px" name="password" aria-required="true" aria-invalid="false" size="40"placeholder="Password" id="firstpass"/>
        </div>
        <div>
        <input  type="password" style="width: 553px; height: 45px; border-color: #c0c0c0; font-weight: bold; padding-left: 5px; border-radius: 10px" aria-required="true" aria-invalid="false" name="confirmPassword" size="40"placeholder="confirm Password" id="secondpass" onblur="check_pass_match();"/>
        </div>
    ...
    padding: 5px 10px;
	font-weight:bold;
	text-transform:uppercase;" value="Sign Up" />
        </div>
      ...
      function check_pass_match(){
                ...
                if (second_password==""){
                     ...
                     does_password_match=0;
                         ...
                         if (second_password!==first_password ) { //matching and not empty
      ...
      function checkphone(){
               ...
               if(p===""){
                ...
                if (p.match(/^\d{2}-\d{6}$/)===null){
                    ...
                    alert("Wrong phone format (dd-dddddd)");
      ...
      function checkemail(){
           ...
           if(p===""){
                   ...
                   is_mail_format_correct=0;
               }else
           if (p.match(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/)===null){
           
           alert("Wrong email format");
               is_mail_format_correct=0;
           }else{
               
                is_mail_format_correct=1;
           }
      }
...
<link rel="stylesheet" type="text/css" href="css/sweetalert.css">
    <script>
        ...
        swal({
            title: "Attention!",
            text: "You already have an account with the same email, please go to login",
            type: "error"
        }, function() {
