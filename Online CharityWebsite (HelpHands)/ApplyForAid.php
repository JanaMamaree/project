...
if($donation=="Type Of Donation*"||$city==""||$street==""||$item==""){
    header('location:swalFalse.php');
}
else{
$sql_add_query = "INSERT INTO aid(email, city, street, donation, item, status, uploaded_on) VALUES('$email','$city','$street','$donation', '$item','Pending....',NOW())";
if(mysqli_query($con, $sql_add_query) === FALSE) die("Could not add the new booking");
...
<div class="container">
<div class="row"> 
<div class="col-sm-6"><h1>APPLY FOR AID</h1></div>
...
<h2 style="margin-top:0;">PLEASE ENTER YOUR INFORMATION TO APPLY FOR AID</h2>
<div class="con-form clearfix">
    <form method="POST">
        
<div class="col-md-6">
<input type="text" name="street"  id="street" value="" size="40" class="" aria-required="true" aria-invalid="false" placeholder="Street Address*">
</div>
<div class="col-md-6">
<input type="text" name="city" id="city" value="" size="40" class="" aria-required="true" aria-invalid="false" placeholder="City / Town*">
</div>
    <div class="col-md-6">
        <br>
        <select name="donation" id="type" style="width: 553px; height: 45px; border-color: #c0c0c0; font-weight: bold; padding-left: 5px;">
            <option>Type Of Donation*</option>
  ...
  <div class="col-md-6">
<input type="text" name="item" id="item" value="" size="40" class="" aria-required="true" aria-invalid="false" placeholder="Item Name*">
</div> 
...
<div class="col-xs-12 submit-button">
    ...
    <input type="submit" value="Apply Now" class="btn2" id="sub" style="border:none; margin: 20px 0 0 0"> </td><br>
