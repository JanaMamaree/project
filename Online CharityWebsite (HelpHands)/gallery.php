...
<li>
<a href="images/gg4.jpg" class="swipebox" title="My Caption">
<div class="image"><img src="images/gg4.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
<li>
<a href="images/gg5.jpg" class="swipebox" title="My Caption">
<div class="image"><img src="images/gg5.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
<li>
<a href="images/gg6.jpg" class="swipebox" title="My Caption">
<div class="image"><img src="images/gg6.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
<li>
<a href="images/gg7.jpg" class="swipebox" title="My Caption">
<div class="image"><img src="images/gg7.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
...
<li>
<a href="images/gg9.jpg" class="swipebox" title="My Caption">
<div class="image"><img src="images/gg9.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div></a>
</li>
<li>
...
<li>
    <a href="images/a.jpg" class="swipebox" title="My Caption">
        <div class="image"><img src="images/a.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
<li>
    <a href="images/b.jpg" class="swipebox" title="My Caption">
        <div class="image"><img src="images/b.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
<li>
    <a href="images/c.jpg" class="swipebox" title="My Caption">
        <div class="image"><img src="images/c.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
<li>
    <a href="images/d.jpg" class="swipebox" title="My Caption">
        <div class="image"><img src="images/d.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
<li>
    <a href="images/e.jpg" class="swipebox" title="My Caption">
        <div class="image"><img src="images/e.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
<li>
    <a href="images/f.jpg" class="swipebox" title="My Caption">
        <div class="image"><img src="images/f.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
<li>
    <a href="images/g.jpg" class="swipebox" title="My Caption">
        <div class="image"><img src="images/g.jpg">
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
...
while ($row = mysqli_fetch_assoc($result)) {
    ?>
<li>
    <a  href="<?php echo 'uploads/'.$row["file_name"]; ?>"  class="swipebox" title="My Caption">
        <div class="image"><img style="width: 474px; height: 270px" src="<?php echo 'uploads/'.$row["file_name"]; ?>" alt="" />
<div class="overlay"><i class="fa fa-search-plus"></i></div>
</div>
</a>
</li>
