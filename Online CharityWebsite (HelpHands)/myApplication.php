...
<div class="col-sm-6"><h1>MY APPLICATION</h1></div>
    ...
    <br>
    <h2 style="margin-left: 500px">Aid Applications</h2>
    <br>
    <form method="POST" align="center" class="form-inline" action="search1.php">
  ...
  <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
    ...
    <p style="margin-left: 480px; color: #f56200">Only confirmed Aid Applications will be shown to others.</p>
   
    <p style="margin-left: 330px; color: #f56200">When your application is accepted, our team will contact you via email with all details within 24 hours.</p>
<?php
require_once 'connection.php';
      
$getorders = "select id, email, donation, item,status from aid where email='$email'";
...
?>
<tr><td scope="row"><?=$row['id']?></td><td scope="row"><?=$row['email']?></td><td scope="row"><?=$row['donation']?></td><td scope="row"><?=$row['item']?></td><td scope="row"><?=$row['status']?></td><td scope="row"><a href="deleteaidswal.php?id=<?=$row['id']?>"><button class="btn btn-sm btn-danger btn-rounded"  type="button">Delete</button></td></tr>
...
<br>
    ...
    <h2 style="margin-left: 520px">Aid Requests</h2>
    <br>
    <p style="margin-left: 480px; color: #f56200">Only confirmed Aid Requests will be shown to donator.</p>
<?php
...
?>
<tr><td scope="row"><?=$row2['id']?></td><td scope="row"><?=$row2['donator']?></td><td scope="row"><?=$row2['applicant']?></td><td scope="row"><?=$row2['donation']?></td><td scope="row"><?=$row2['item']?></td><td scope="row"><?=$row2['status']?></td><td scope="row"><a href="deleteaid1swal.php?id=<?=$row2['id']?>"><button class="btn btn-sm btn-danger btn-rounded"  type="button">Delete</button></td></tr>
...
<br>
    ...
    <h2 style="margin-left: 500px">Donation Requests</h2>
    <br>
    <p style="margin-left: 520px; color: #f56200">You can not reject an accepted request.</p>
<?php
