...
<link rel="stylesheet" type="text/css" href="css/sweetalert.css">
    ...
    swal({
  title: "Are you sure?",
  text: "this will accept the request to your donation",
  type: "warning",
  showCancelButton: true,
  confirmButtonClass: "btn-success",
  confirmButtonText: "Yes, accept & donate",
...
function(isConfirm) {
  if (isConfirm) {
     window.location = "accept.php?donator=<?=$email1?>&donation=<?=$type?>&item=<?=$item?>&id=<?=$id?>&applicant=<?=$a?>";
  } else {
...
?>
<tr><td scope="row"><?=$row['id']?></td><td scope="row"><?=$row['email']?></td><td scope="row"><?=$row['donation']?></td><td scope="row"><?=$row['item']?></td><td scope="row"><?=$row['status']?></td><td scope="row"><a href="deleteaid.php?id=<?=$row['id']?>"><button style="background-color: #c1e2b3;" type="button">Delete</button></td></tr>
...
?>
<tr><td scope="row"><?=$row2['id']?></td><td scope="row"><?=$row2['donator']?></td><td scope="row"><?=$row2['applicant']?></td><td scope="row"><?=$row2['donation']?></td><td scope="row"><?=$row2['item']?></td><td scope="row"><?=$row2['status']?></td><td scope="row"><a href="deleteaid1.php?id=<?=$row2['id']?>"><button style="background-color: #c1e2b3;" type="button">Delete</button></td></tr>
        ...
        <?php  
                                 if($row1['status']=="Rejected"){
                                  ...
                                  <?php  
                                      ...
                                      ?>
                                  <a href="accept.php?id=<?=$row1['id']?>&donator=<?=$row1['donator']?>&donation=<?=$row1['donation']?>&item=<?=$row1['item']?>&applicant=<?=$row1['applicant']?>">
