...
if($number==""||$owner==""||$amount==""||$exp==""||$code=""){
    header("location:swalFalse.php");
}
else{
$sql_add_query = "INSERT INTO donationcash(email, owner, number, amount) VALUES('$email','$owner','$number','$amount')";
...
<div class="container">
<div class="row"> 
<div class="col-sm-6"><h1>IN-CASH DONATIONS</h1></div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" method="POST">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group"> <label>Card Number</label>
                                        <div class="input-group"> <input type="text" class="form-control" name="number" placeholder="Valid Card Number" /> <span class="input-group-addon"><span class="fa fa-credit-card"></span></span> </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-7 col-md-7">
                                    <div class="form-group"> <label><span class="hidden-xs">Expiration</span><span class="visible-xs-inline">EXP</span> DATE</label> <input name="exp"type="date" class="form-control" /> </div>
                                </div>
                                <div class="col-xs-5 col-md-5 pull-right">
                                    <div class="form-group"> <label>CV Code</label> <input type="text" name="code"class="form-control" placeholder="CVC" /> </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group"> <label>Amount in thousand LBP</label> <input type="number" name="amount" class="form-control" placeholder="Ex: 10=10,000 LBP" </div>
                                </div>
                            </div>
