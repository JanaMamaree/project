    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <?php
                      require_once '../connection.php';        
                      $getaid="select * from getaid";
                      $result = mysqli_query($con, $getaid);
                      if(mysqli_num_rows($result)== 0){
                        echo "<br> <p align='center' style='font-size:20px'> no aid requests found </p>";
                          ...
                          <div class="col-lg-12 grid-margin stretch-card">
                           <div class="card">
                            <div class="card-body">
                             <h4 class="card-title">Aid Requests</h4>
                          ...
                          ?>
                            ...
                            <tr>
                              ...
                              <td>
                                  ...
                                  <a href="removeaid1.php?id=<?=$row['id']?>">
                                    <button type="button" class="btn btn-outline-danger btn-fw btn-rounded">Delete</button>
                                  </a>
                                  <?php  
                                  }
                                  ...
                                  ?>  
                                    <a href="confirmaid1.php?id=<?=$row['id']?>">
                                    <button type="button" class="btn btn-outline-success btn-fw btn-rounded">Confirm</button>
                                  </a>
                                  <a href="rejectaid1.php?id=<?=$row['id']?>">
                                    <button type="button" class="btn btn-outline-danger btn-fw btn-rounded">Reject</button>
                                  </a>
                                  <?php
                                  }
                                  ?>                                
