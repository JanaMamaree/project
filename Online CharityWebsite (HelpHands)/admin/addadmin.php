...
$sql_add_query = "INSERT INTO admins (first, last,phone,email,password) VALUES('$first','$last','$phone','$email', '$pass')";
          ...
          <?php
                      ...
                      if(mysqli_num_rows($result)== 0){
                        echo '<div class="col-lg-12 grid-margin stretch-card">
                         ...
                         <td>
                                    <input type="submit" value="ADD" class="btn btn-success btn-rounded btn-icon"/>
                                </td>
                                </form>
