          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
               ...
               <?php
             require_once '../connection.php';
                      $getcash="select * from donationkind";
                      $result = mysqli_query($con, $getcash);
                      if(mysqli_num_rows($result)== 0){
                        echo "<br> <p align='center' style='font-size:20px'> no in-kind donations found </p>";
                      }
                      else{
                          echo'
                          <div class="col-lg-12 grid-margin stretch-card">
                           <div class="card">
                            <div class="card-body">
                             <h4 class="card-title">In-kind donators</h4>
                             <p class="card-description">
                            All in-kind donations will be shown here
                             </p>
                      ...
                      <tbody>';
                          ...
                          ?>
                            ...
                            <tr>
                              ...
                              <td>
                                  <img style="width: 150px; height: 150px" src="<?php echo '../uploads/'.$row["file_name"]; ?>" alt="" />
                              </td>
                               <td>
                                  <?=$row['uploaded_on']?>
                              </td> 
                                  ...
                                  <td>
                                  <a href="removekind.php?email=<?=$row['email']?>">
                                    <button type="button" class="btn btn-danger btn-rounded btn-fw">Remove</button>
                                  </a>
                              </td> 
                            </tr>
                      <?php  
