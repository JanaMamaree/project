    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <!-- start of table-->
                      <?php
                      $getusers="select * from donedonate";
                      $result = mysqli_query($con, $getusers);
                      if(mysqli_num_rows($result)== 0){
                        echo "<br> <p align='center' style='font-size:20px'> no successful donations found </p>";
                      }
                      else{
                          echo'
                          <div class="col-lg-12 grid-margin stretch-card">
                           <div class="card">
                            <div class="card-body">
                             <h4 class="card-title">Successful donations</h4>
                             <p class="card-description">
                              Email must be sent to each applicant and donator with the same code
                             </p>
                      ...
                      <tbody>';
                          ...
                          ?>
                            ...
                            <tr>
                             ...
                             <td>
                                 <a href="sendemail.php?id=<?=$row['id']?>&donator=<?=$row['donator']?>&applicant=<?=$row['applicant']?>&donation=<?=$row['donation']?>&item=<?=$row['item']?>">
                        ...
                        <i class="ti-email"></i>
                              ...
                              <td>
                                 ...
                                 <a href="removedone.php?id=<?=$row['id']?>">
