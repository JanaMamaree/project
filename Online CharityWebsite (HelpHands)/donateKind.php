...
<div class="container">
<div class="row"> 
<div class="col-sm-6"><h1>IN-KIND DONATIONS</h1></div>
...
<h2 style="margin-top:0;">PLEASE ENTER YOUR INFORMATION TO MAKE DONATION</h2>
...
<input type="text" name="item" id="item" value="" size="40" class="" aria-required="true" aria-invalid="false" placeholder="Item Name*">
        ...
        <div class="col-md-6">
        <input style="margin-top: 35px; margin-left: 480px" type="file" name="file">
        </div>
        
<div class="col-xs-12 submit-button">
    <br>
    
    <input class="btn2" style="border:none; margin: 20px 0 0 0" type="submit" name="submit" value="Upload">
