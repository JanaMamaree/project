...
if ( isset($_POST['name']) && isset($_POST['name']) && isset($_POST['email']) &&
...
// add values to the db to the table users
$query = "SELECT email FROM users WHERE email='$email'";
$result = mysqli_query($con,$query);
if(mysqli_num_rows($result)== 0){
 if($name==""||$email==""||$password==""||$phone==""){
   header('location:falsecreation.php');
}else{
$sql_add_query = "INSERT INTO users VALUES('$name','$last','$phone','$email',md5('$password'))";
header('location:truecreation.php');
...
header('location:yesaccount.php');
...
<div class="con-form clearfix">
    <form method="POST">
        ...
        <div >
            <input  type="text" style="width: 553px; height: 45px; border-color: #c0c0c0; font-weight: bold; padding-left: 5px; border-radius: 10px" name="email" aria-required="true" aria-invalid="false" size="46" placeholder="Email" id="email"/>
        </div>
        <div >
        <input type="text"style="width: 553px; height: 45px; border-color: #c0c0c0; font-weight: bold; padding-left: 5px; border-radius: 10px" name="phone" aria-required="true" aria-invalid="false" size="46"placeholder="Phone Number" id="phone"/>
        </div>
        <div >
